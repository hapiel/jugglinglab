...
// WORK IN PROGRESS, an input panel for testing new stuff :)

public class DNotePattern extends MHNPattern {
    ...
    @Override
    public DNotePattern fromString(String conf) throws JuggleExceptionUser, JuggleExceptionInternal {
    ...
    @Override
    public DNotePattern fromParameters(ParameterList pl) throws
